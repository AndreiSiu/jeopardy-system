...
# Load the spaCy English model (make sure to install it first: pip install spacy)
...
def evaluate_jeopardy_system(questions_file):
    ...
    with open(f'./{directory}/results_keywords_clue.txt', "w", encoding="utf-8") as output_file:
        with ix.searcher(weighting=scoring.TF_IDF()) as searcher:
            ...
            with open(questions_file, 'r', encoding='utf-8') as file:
                ...
                for i in tqdm(range(0, len(lines), 4), desc="Processing Questions", unit=" question"):
                    ...
                    # Extract keywords from the clue
